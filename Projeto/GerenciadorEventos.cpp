...
GerenciadorEventos::GerenciadorEventos():
	pGG(pGG->getGrafico()), pJogador(nullptr)
{
...
void GerenciadorEventos::setJogador(Personagens::Jogadores::Jogador* pJogador)
{
	this->pJogador = pJogador;
}

void GerenciadorEventos::setJogador2(Personagens::Jogadores::Jogador* pJogador2)
{
